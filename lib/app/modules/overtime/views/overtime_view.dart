                ...
                children: [
                  Row(
                    children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              StreamBuilder<
                                ...
                                stream:
                                    controller.streamPerizinanCount("overtime"),
                      ...
                      //         image:
                      //             AssetImage('assets/gradient_line_2.jpg'),
                      //         fit: BoxFit.cover,
                      //       ),
                      //     ),
                      //     child: Column(
                            ...
                            children: [
                              ...
                              GetBuilder<OvertimeController>(
                                builder: (c) => FutureBuilder(
                                  future: controller.overtimeStatus("approved"),
                                  builder: (context, snapshot) {
                                    // print(snapshot.data!.docs.length);
                                    if (snapshot.hasData) {
                                      return Text(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              GetBuilder<OvertimeController>(
                                builder: (c) => FutureBuilder(
                                  future: controller.overtimeStatus("pending"),
                                  builder: (context, snapshot) {
                                    // print(snapshot.data!.docs.length);
                                    if (snapshot.hasData) {
                                      return Text(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              GetBuilder<OvertimeController>(
                                builder: (c) => FutureBuilder(
                                  future: controller.overtimeStatus("rejected"),
                                  builder: (context, snapshot) {
                                    // print(snapshot.data!.docs.length);
                                    if (snapshot.hasData) {
                                      return Text(
