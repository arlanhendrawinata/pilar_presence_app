...
class ManagementAnnouncementView
    extends GetView<ManagementAnnouncementController> {
  const ManagementAnnouncementView({Key? key}) : super(key: key);
  @override
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: InkWell(
              onTap: () => Get.toNamed(Routes.ANNOUNCEMENT_ADD),
              child: const Icon(
